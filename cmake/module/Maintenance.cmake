...
function(add_maintenance_targets)
  ...
  foreach(target IN ITEMS bitcoind bitcoin-qt bitcoin-cli bitcoin-depgraph bitcoin-tx bitcoin-util bitcoin-wallet test_bitcoin bench_bitcoin)
    if(TARGET ${target})
...
function(add_windows_deploy_target)
  if(MINGW AND TARGET bitcoin-qt AND TARGET bitcoind AND TARGET bitcoin-cli AND TARGET bitcoin-tx AND TARGET bitcoin-depgraph AND TARGET bitcoin-wallet AND TARGET bitcoin-util AND TARGET test_bitcoin)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:bitcoin-depgraph> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:bitcoin-depgraph>
