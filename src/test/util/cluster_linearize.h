...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        0,
        0, 2, 8, 21, 43, 79, 129, 184,
        241, 319, 427, 548, 628, 743, 841, 1011,
        1277, 1377, 1504, 1811, 1931, 2013, 2598, 2551,
        2798, 3787, 3458, 3705, 3979, 4549, 6428, 6550,
        5501, 6838, 7095, 8691, 10338, 11696, 12329, 12164,
        11824, 21702, 12481, 18039, 13450, 18879, 18199, 12327,
        21508, 39592, 17124, 22809, 23840, 41202, 24576, 36236,
