...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        0,
        0, 528, 894, 1529, 2424, 3841, 5082, 6449,
        8664, 10203, 12752, 14667, 18368, 22582, 25191, 28529,
        36846, 40161, 47310, 44545, 59288, 56003, 76151, 85813,
        105483, 108498, 116919, 129304, 146872, 143549, 154173, 176623,
        166986, 197177, 196330, 217705, 232976, 275337, 461356, 355916,
        378620, 552370, 366586, 577995, 440250, 538589, 488484, 531082,
        627160, 1155147, 863907, 1046333, 1155236, 1152998, 1501531, 1408208,
        1468474, 1969783, 1803482, 1877247, 2181021, 2608809, 2121458, 2645381
    };
