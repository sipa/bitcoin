...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        ...
        1195, 1501, 1540, 1614, 2170, 2174, 2578, 2969,
        3158, 3683, 3846, 3914, 4463, 4941, 5256, 5184,
        6773, 7117, 8058, 7605, 8959, 9435, 9584, 8954,
        11644, 11875, 12731, 12341, 17504, 20363, 16567, 20479,
        17855, 22512, 20062, 22212, 23132, 31823, 29761, 32712,
        36946, 37437, 36663, 42822, 49803, 53532, 67352, 63584
    };
