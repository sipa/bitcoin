...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        ...
        259, 319, 427, 548, 628, 743, 841, 919,
        1277, 1377, 1540, 1811, 1931, 2011, 2598, 2551,
        2798, 3721, 3489, 3730, 3801, 4549, 4707, 7538,
        6300, 5545, 6877, 8468, 9361, 10764, 13049, 11425,
        12671, 22119, 14077, 15153, 13016, 15390, 19922, 11393,
        24606, 26519, 23539, 24973, 21903, 48258, 29657, 31022,
        28048, 37715, 45867, 59128, 52334, 83941, 43893, 106502
    };
