...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        ...
        105483, 108498, 116919, 129304, 146872, 143549, 154173, 161555,
        166986, 197177, 196330, 217311, 232976, 195394, 205699, 292107,
        301955, 248520, 350440, 356801, 440250, 438591, 488484, 515978,
        538675, 409308, 522910, 588303, 591073, 539680, 564341, 513115,
        552524, 713500, 647896, 675764, 812408, 822958, 1002562, 923146
    };
