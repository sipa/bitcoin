...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        0,
        0, 2, 8, 21, 43, 79, 129, 200,
        254, 321, 440, 548, 654, 797, 863, 1018,
        1289, 1510, 1516, 1706, 2247, 2011, 2521, 3017,
        3019, 3785, 3850, 3892, 4526, 4844, 4880, 6176,
        6655, 6243, 8575, 7337, 8406, 10390, 10243, 9173,
        11358, 10564, 11370, 13369, 14367, 18312, 17033, 18252,
        19846, 19758, 19306, 22432, 24323, 28108, 32372, 32088,
        46614, 42591, 34174, 35598, 76814, 45585, 51052, 63936
    };
