...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        ...
        259, 321, 440, 542, 673, 825, 914, 1067,
        1195, 1501, 1616, 1614, 2170, 2174, 2578, 2969,
        3144, 3683, 3846, 3891, 4463, 4941, 5256, 5184,
        6773, 6388, 8058, 7394, 8959, 9455, 10041, 9466,
        10409, 12051, 13989, 14027, 14637, 19602, 17249, 20337,
        18713, 22084, 25877, 21833, 24637, 30788, 38536, 33991,
        34712, 39057, 49326, 47752, 54233, 51731, 59373, 70870
    };
