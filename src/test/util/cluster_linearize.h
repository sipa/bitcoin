...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        ...
        1289, 1510, 1614, 1706, 2247, 2100, 2521, 3017,
        3019, 3785, 3850, 4077, 4526, 4844, 4880, 5573,
        6777, 7498, 8575, 9004, 8406, 8843, 8901, 9520,
        9987, 11114, 12106, 13800, 15213, 16419, 19471, 16129,
        18385, 18228, 22943, 20025, 24204, 24028, 24409, 39522,
        45140, 41684, 36137, 62550, 59199, 47153, 58734, 59018
    };
