...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        ...
        1289, 1510, 1614, 1706, 2247, 2168, 2521, 3017,
        3019, 3785, 3850, 3938, 5306, 4844, 4880, 5573,
        6655, 6039, 8575, 8344, 7871, 8682, 9470, 9129,
        10998, 11245, 12106, 13800, 14880, 16923, 17401, 16467,
        16154, 19322, 31684, 22355, 25936, 32075, 41429, 30274,
        37441, 40298, 46645, 37807, 59199, 53713, 63259, 76364
    };
