...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        ...
        259, 321, 440, 548, 602, 797, 863, 1000,
        1289, 1510, 1614, 1841, 2247, 2168, 2521, 3017,
        3019, 3785, 3850, 3938, 5306, 4844, 4880, 4987,
        6655, 6039, 8575, 8331, 7871, 8682, 9470, 9129,
        10998, 11245, 12106, 13800, 14880, 16923, 17397, 16467,
        17628, 18717, 31684, 22355, 25936, 32075, 41429, 31688,
        40575, 40298, 46645, 37807, 59199, 58470, 63259, 76364
    };
