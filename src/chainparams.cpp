...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 2000000000; // Far in the future
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 2100000000;
