...
{
    return SignatureHash(scriptCode, txTo, nIn, nHashType, amount, sigversion, CachedHashes());
}
...
bool TransactionSignatureChecker::CheckSig(const vector<unsigned char>& vchSigIn, const vector<unsigned char>& vchPubKey, const CScript& scriptCode, int sigversion)
{
