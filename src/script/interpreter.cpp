                ...
                case OP_CHECKSIGADD:
                {
                    ...
                    case SigVersion::TAPSCRIPT:
                    {
                        ...
                        if (fSuccess) {
                            ...
                            execution_cost += VALIDATION_WEIGHT_PER_SIGOP_PASSED;
                            if (fSuccess && (execution_cost > execdata.m_witness_weight + VALIDATION_WEIGHT_OFFSET)) {
                        ...
                        if (vchPubKey.size() == 0) {
                            ...
                            if (fSuccess && !checker.CheckSigSchnorr(vchSig, vchPubKey, sigversion, execdata)) {
                                return set_error(serror, SCRIPT_ERR_SIG_NULLFAIL);
                            }
                        } else {
                            /*
