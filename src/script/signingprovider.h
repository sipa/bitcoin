...
public:
    ...
    virtual bool GetTaprootSpendData(const XOnlyPubKey& pk, TaprootSpendData& spenddata) const { return false; }
};
...
public:
    ...
    bool GetTaprootSpendData(const XOnlyPubKey& pk, TaprootSpendData& spenddata) const override;
};
