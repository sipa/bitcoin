...
bool HidingSigningProvider::GetTaprootSpendData(const XOnlyPubKey& pk, TaprootSpendData& spenddata) const
{
    return m_provider->GetTaprootSpendData(pk, spenddata);
}
...
bool FlatSigningProvider::GetTaprootSpendData(const XOnlyPubKey& pk, TaprootSpendData& spenddata) const { return LookupHelper(tr_spenddata, pk, spenddata); }
...
FlatSigningProvider Merge(const FlatSigningProvider& a, const FlatSigningProvider& b)
{
    ...
    ret.tr_spenddata.insert(b.tr_spenddata.begin(), b.tr_spenddata.end());
    return ret;
}
