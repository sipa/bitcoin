...
public:
    ...
    {
        return {m_block_template->fee_lower_bound, m_block_template->fee_achieved, m_block_template->fee_dp_chunks, m_block_template->fee_dp_txn, m_block_template->fee_upper_bound};
    }
